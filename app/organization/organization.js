(function() {
    ...
    function Organization($rootScope, $scope, $timeout, API, State, DTOptionsBuilder, DTColumnDefBuilder) {
        ...
        function updateImageURL() {
            vm.imageUrl = vm.organization && vm.organization.imageUrl &&
                vm.organization.imageUrl.replace("static.hopestream.com", "hopestream.s3.amazonaws.com") + '?' + new Date().getTime();
